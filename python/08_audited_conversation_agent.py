...
def main() -> None:
    print("=" * 68)
    print("Oracle AI Accounts Receivable Agent — Audited Conversation")
    print("=" * 68)

    print(
        "\nCommands:"
        "\n  clear   Clear temporary conversation memory"
        "\n  context Display current session memory"

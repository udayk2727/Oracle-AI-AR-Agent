...
def main() -> None:
    print("=" * 68)
    print("Oracle AI Accounts Receivable Agent — Approval Workflow")
    print("=" * 68)

    print(
        "\nCommands:"
        "\n  request reminder <invoice_number>  Create reminder approval"
    ...
    try:
        while True:
            ...
            # ==================================================
            # DAY 14 — CREATE PAYMENT REMINDER APPROVAL
            # IMPORTANT:
            # This must happen BEFORE the normal AI router.
            # ==================================================
            ...
            if command.startswith("approve "):
                ...
                if updated:
                    ...
                    print(
                        "No payment reminder has been sent yet."
                    )
            ...
            # Everything above this point is a console command.
            # ==================================================
